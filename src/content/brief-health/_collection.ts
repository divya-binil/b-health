...
const collectionIdentity = 'brief-health' as const;
...
export const briefHealthCollection = ac.defineCollection({ schema: s.briefHealthSchema });
export const briefHealthNavigationTree = singleton(async () => {
// const entries = await ac.getCollection(collectionIdentity);
const entries = await ac.getCollection(collectionIdentity, ({ data }) => {
...
export default briefHealthCollection;