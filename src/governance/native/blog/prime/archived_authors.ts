export const blogPrimeAuthorSlugs = [
  "unknown",
  "shahid-shah",
  "ajay-kumaran-nair",
  "jijo-mp",
...
export type BlogPrimeAuthorSlug = (typeof blogPrimeAuthorSlugs)[number];

export interface Props {
  readonly name: string;
  readonly slug: BlogPrimeAuthorSlug;
...
export const authors: Props[] = [
  {
    ...
    aliases: [
      ...
      {
        identity: "shahid_shah",
        provenance: "git.netspective.io",
      },
    ],
  },
  {
